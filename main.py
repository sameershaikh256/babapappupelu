    ...
    try:
        for i in range(count - 1, len(links)):
            ...
            try:  
                ...
                cc = f'**\n❀° ┄───╮**\n✦** {str(count).zfill(3)}.✦\n**╰───┄ °❀\n\n\n**🦇 𝗟𝗘𝗖 𝗡𝗔𝗠𝗘 ** ➺ {name1}.\n├── Resolution➥ ({res}).\n├── Extention➥ @ALEXANDER_OFFICIAL_091.mkv\n\n\n**<pre><code>🦈 𝗕𝗔𝗧𝗖𝗛 𝗡𝗔𝗠𝗘** ➺ **{b_name}</code></pre>**\n\n\n**❦ 𝐃𝐎𝐖𝐍𝐋𝐎𝐀𝐃 𝐁𝐘 ** ➽  **\n\n༶•┈┈⛧┈♛┈⛧┈┈•༶**\n\n**{raw_text3} \n\n**༶•┈┈⛧┈♛┈⛧┈┈•༶**'
                #cpw = f'**\n❀° ┄───╮**\n✦:** {str(count).zfill(3)}.✦\n**╰───┄ °❀\n\n\n**🦇 𝗟𝗘𝗖 𝗡𝗔𝗠𝗘 ** ➺ {name1}.\n├── Resolution➥ ({res}).\n├── Extention➥ @ALEXANDER_OFFICIAL_091.mkv\n\n\n**🔗𝗩𝗶𝗱𝗲𝗼 𝗨𝗿𝗹 ➤ <a href="{url}">__**Click Here to Watch Video**__</a>**\n\n\n**<pre><code>🦈 𝗕𝗔𝗧𝗖𝗛 𝗡𝗔𝗠𝗘** ➺ **{b_name}</code></pre>**\n\n\n**❦ 𝐃𝐎𝐖𝐍𝐋𝐎𝐀𝐃 𝐁𝐘 ** ➽  **\n\n༶•┈┈⛧┈♛┈⛧┈┈•༶**\n\n{raw_text3} \n\n**༶•┈┈⛧┈♛┈⛧┈┈•༶**'
                #cyt = f'**\n❀° ┄───╮**\n✦** {str(count).zfill(3)}.✦\n**╰───┄ °❀\n\n\n**🦇 𝗟𝗘𝗖 𝗡𝗔𝗠𝗘 ** ➺ {name1}.\n├── Resolution➥ ({res}).\n├── Extention➥ @ALEXANDER_OFFICIAL_091.mp4\n\n\n**🔗𝗩𝗶𝗱𝗲𝗼 𝗨𝗿𝗹 ➤ <a href="{url}">__**Click Here to Watch Video**__</a>**\n\n\n**<pre><code>🦈 𝗕𝗔𝗧𝗖𝗛 𝗡𝗔𝗠𝗘** ➺ **{b_name}</code></pre>**\n\n\n**❦ 𝐃𝐎𝐖𝐍𝐋𝐎𝐀𝐃 𝐁𝐘 ** ➽  **\n\n༶•┈┈⛧┈♛┈⛧┈┈•༶**\n\n{raw_text3} \n\n**༶•┈┈⛧┈♛┈⛧┈┈•༶'
                cpvod = f'**\n❀° ┄───╮**\n✦** {str(count).zfill(3)}.✦\n**╰───┄ °❀\n\n\n**🦇 𝗟𝗘𝗖 𝗡𝗔𝗠𝗘 ** ➺ {name1}.\n├── Resolution➥ ({res}).\n├── Extention➥ @ALEXANDER_OFFICIAL_091.mkv\n\n\n**🔗𝗩𝗶𝗱𝗲𝗼 𝗨𝗿𝗹 ➤ <a href="{url}">__**Click Here to Watch Video**__</a>**\n\n\n**<pre><code>🦈 𝗕𝗔𝗧𝗖𝗛 𝗡𝗔𝗠𝗘** ➺ **{b_name}</code></pre>**\n\n\n**❦ 𝐃𝐎𝐖𝐍𝐋𝐎𝐀𝐃 𝐁𝐘 ** ➽  **\n\n༶•┈┈⛧┈♛┈⛧┈┈•༶**\n\n{raw_text3} \n\n**༶•┈┈⛧┈♛┈⛧┈┈•༶**'
                cimg = f'**\n❀° ┄───╮**\n✦** {str(count).zfill(3)}.✦\n**╰───┄ °❀\n\n\n**🍷 𝗣𝗗𝗙 𝗡𝗔𝗠𝗘 ** ➺ {name1}.\n├── Extention➥ @ALEXANDER_OFFICIAL_091jpg\n\n\n**<pre><code>🦈 𝗕𝗔𝗧𝗖𝗛 𝗡𝗔𝗠𝗘** ➺ **{b_name}</code></pre>**\n\n\n**❦ 𝐃𝐎𝐖𝐍𝐋𝐎𝐀𝐃 𝐁𝐘 ** ➽  **\n\n༶•┈┈⛧┈♛┈⛧┈┈•༶**\n\n{raw_text3} \n\n**༶•┈┈⛧┈♛┈⛧┈┈•༶**'
                cczip = f'**\n❀° ┄───╮**\n✦** {str(count).zfill(3)}.✦\n**╰───┄ °❀\n\n\n**🍷 𝗣𝗗𝗙 𝗡𝗔𝗠𝗘 ** ➺ {name1}.\n├── Extention➥ @ALEXANDER_OFFICIAL_091.zip\n\n\n**<pre><code>🦈 𝗕𝗔𝗧𝗖𝗛 𝗡𝗔𝗠𝗘** ➺ **{b_name}</code></pre>**\n\n\n**❦ 𝐃𝐎𝐖𝐍𝐋𝐎𝐀𝐃 𝐁𝐘 ** ➽  **\n\n༶•┈┈⛧┈♛┈⛧┈┈•༶**\n\n{raw_text3} \n\n**༶•┈┈⛧┈♛┈⛧┈┈•༶**'
                cc1 = f'**\n❀° ┄───╮**\n✦** {str(count).zfill(3)}.✦\n**╰───┄ °❀\n\n\n**🍷 𝗣𝗗𝗙 𝗡𝗔𝗠𝗘 ** ➺ {name1}.\n├── Extention➥ @ALEXANDER_OFFICIAL_091.pdf\n\n\n**<pre><code>🦈 𝗕𝗔𝗧𝗖𝗛 𝗡𝗔𝗠𝗘** ➺ **{b_name}</code></pre>**\n\n\n**❦ 𝐃𝐎𝐖𝐍𝐋𝐎𝐀𝐃 𝐁𝐘 ** ➽  **\n\n༶•┈┈⛧┈♛┈⛧┈┈•༶**\n\n{raw_text3} \n\n**༶•┈┈⛧┈♛┈⛧┈┈•༶**'
